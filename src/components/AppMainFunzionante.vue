...
<template>
    <main>
        <div class="container-fluid bg-danger">
            ...
            <div class="row">
                <h2 v-if="store.films.length > 0" class="text-center mb-5 mt-5">Film</h2>
                <div v-for="(film, i) in store.films" :key="i" class="col-2 mb-3 p-2">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back px-3 py-4 overflow-y-auto">
                                ...
                                <p class="mb-0">Voto : 
                                    <i v-for="(star, i) in Math.round(film.vote_average / 2)" class="rate-stars fa-solid fa-star"></i>
                                    <i v-for="(star, i) in 5 - Math.round(film.vote_average / 2)" class="fa-regular fa-star"></i>
                                </p>
                                <p class="">Descrizione: {{ film.overview }}</p>
                                <div>
                                    
                                    <img :src="'../src/assets/img2/' + film.original_language + '.png'" :alt="film.original_language">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <h2 v-if="store.series.length > 0" class="text-center mb-5 mt-5">Serie TV</h2>
                <div v-for="(serie, j) in store.series" :key="j" class="col-2 mb-3 p-2">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            <div class="flip-card-front">
                            ...
                            <div class="flip-card-back px-3 py-4 overflow-y-auto">
                                ...
                                <p class="mb-0">Voto : 
                                    <i v-for="(star, j) in Math.round(serie.vote_average / 2)" class="rate-stars fa-solid fa-star"></i>
                                    <i v-for="(star, j) in 5 - Math.round(serie.vote_average / 2)" class="fa-regular fa-star"></i>
                                </p>
                                <p class="">Descrizione: {{ serie.overview }}</p>
                                <div>
                                    <img :src="'../src/assets/img2/' + serie.original_language + '.png'" :alt="serie.original_language">
                                </div>
                            </div>
                        </div>
                    </div>
